People Coin is an open source project and we would love you to help us make it better.
...
2. Run the tests. This is to make sure your starting point works. TBD on how tests can be run
