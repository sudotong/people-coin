...
Template['components_sellContract'].onRendered(function(){
    TemplateVar.set('state', {isInactive: true});
});

Template['components_sellContract'].helpers({
...
Template['components_sellContract'].events({
	...
	*/
	...
	"keyup #sellValue": function(event, template){
        // the input value
		var value = template.find("#sellValue").value;
